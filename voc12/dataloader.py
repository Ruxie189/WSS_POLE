...
class VOC12ImageDataset(Dataset):
    ...
    def __init__(self, img_name_list_path, voc12_root,
                 resize_long=None, rescale=None, img_normal=TorchvisionNormalize(), hor_flip=False, ver_flip=False,
        ...
        self.ver_flip = ver_flip #Added global var for ver_flip
    ...
    def __getitem__(self, idx):
        ...
        if self.ver_flip: #Added top-down flip for better consistency in train class....rB
            img = imutils.random_ud_flip(img)
...
class VOC12ClassificationDataset(VOC12ImageDataset):
    ...
    def __init__(self, img_name_list_path, voc12_root,
        ...
        super().__init__(img_name_list_path, voc12_root,
                 resize_long, rescale, img_normal, hor_flip, ver_flip,
...
class VOC12ImageClipPredDataset(Dataset):
    ...
    def __init__(self, img_name_list_path, voc12_root,
        ...
        self.key_prompt_dir  = '/home/ruxie/scratch/ruxie/test_LOTMBTM_recheck/sem_seg'
        self.sen1_prompt_dir = '/home/ruxie/scratch/ruxie/test_LOTMBTM_recheck_sen1/sem_seg'
        self.sen2_prompt_dir = '/home/ruxie/scratch/ruxie/test_LOTMBTM_recheck_sen2/sem_seg'
