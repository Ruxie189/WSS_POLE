...
def run(args):
    if args.clims_network == "net.resnet50_clims": 
        model = getattr(importlib.import_module(args.clims_network), 'CAM')(n_classes=20)
        ...
        model = getattr(importlib.import_module(args.clims_network), 'CAM')(patch_size=16, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4, qkv_bias=True,
