...
from clip_tools.clip_defo_utils import clip_forward, PromptLearner
...
def run(args):
    ...
    model.prompt_learner = PromptLearner(clip_model, device)
    ...
    optimizer = torchutils.PolyOptimizer([
        ...
        {'params': param_groups[2], 'lr': args.clims_defo_lr_factor * args.clims_learning_rate, 'weight_decay': args.cam_weight_decay},
